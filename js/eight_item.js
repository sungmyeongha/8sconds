const ITEM_LIST = [
    ...
    [
        { item_no: 0, src: './img/item/item8.webp', txt: '[🔴50%~] 백 오픈 데님 원피스 - 블랙', price: '39900' },
        { item_no: 1, src: './img/item/item9.webp', txt: '[🟠40%~] 포인텔 백 스트링 풀오버 - 아이보리', price: '15900' },
        { item_no: 2, src: './img/item/item10.webp', txt: '빈티지 프린트 티셔츠 - 애쉬', price: '9900' },
        { item_no: 3, src: './img/item/item11.webp', txt: '[🟠40%~] 허리 셔링 원피스 - 네이비', price: '9900' },
        { item_no: 4, src: './img/item/item12.webp', txt: '[🟢20%~]  쿨터치 강연 조직 카라 반소매 니트 - 블랙', price: '35900' },
        { item_no: 5, src: './img/item/item13.webp', txt: '[🟡30%~]  주름지 밴딩 팬츠 - 블랙', price: '15900' },
        { item_no: 6, src: './img/item/item14.webp', txt: '[🟡30%~]  스모킹 코튼 롱 원피스 - 베이지', price: '19900' },
        { item_no: 7, src: './img/item/item15.webp', txt: '[🔴50%~] 져지 톱 코튼 원피스 - 블랙', price: '19900' }
    ],
    [
        { item_no: 0, src: './img/item/item0.webp', txt: '[🟢20%~]  스트라이프 피케 카라 티셔츠 - 블랙', price: '49900' },
        { item_no: 1, src: './img/item/item1.webp', txt: '[🟢20%~]  나일론 셋업 유틸 쇼츠 - 애쉬', price: '39900' },
...
if(cate_no == 1) {
    for (let i = 0; i <16; i++) {
        ...
        main_item.innerHTML =`
        <img src="${ITEM_LIST[cate_no][i].src}">
            <div class="img_txt">
                <p>8 seconds</p>
                <span>${ITEM_LIST[cate_no][i].txt}{</span>
                <p class="price">${ITEM_LIST[cate_no][i].price}</p>
            </div>`
